    ...
    mainContent.innerHTML = `
        <div id="order-card" style="max-width: 550px; margin: auto; background: white; border-radius: 15px; box-shadow: 0 10px 25px rgba(0,0,0,0.1); overflow: hidden;">
            <div style="padding: 25px; text-align: center; background: #fff;">
                <h2 style="color: #333; margin-bottom: 5px; font-size: 1.6em;">آلة صنع الشارات الاحترافية</h2>
                ...
                <p style="color: #e63946; font-weight: bold; font-size: 1.1em; margin: 10px 0;">⚠️ سارع بالطلب.. الكمية محدودة جداً!</p>
                ...
                <div style="background: #fff5f5; border: 2px dashed #e63946; padding: 15px; border-radius: 12px; margin: 15px 0;">
                    ...
                    <div style="display: flex; align-items: center; justify-content: center; gap: 10px; margin: 5px 0;">
                        ...
                        <h3 style="color: #e63946; font-size: 3em; margin: 0; font-weight: 900;">24,000 دج</h3>
                        <span style="font-size: 2.5em;">🚨</span>
                    </div>
                    <p style="color: #28a745; font-weight: bold; margin: 5px 0 0;">🔥 عرض خاص: قطعتين بـ 47,000 دج فقط!</p>
                </div>
                
                <p style="color: #777; font-size: 0.9em; margin-top: 10px;">* تنبيه: سعر التوصيل غير محتسب في ثمن المنتج</p>
            </div>

            <div id="form-container" style="padding: 25px; background: #fafafa; border-top: 1px solid #eee;">
                <input type="text" id="fullname" placeholder="الإسم واللقب الكامل *" style="width:100%; padding:15px; margin-bottom:12px; border:1px solid #ddd; border-radius:10px; box-sizing:border-box; font-size: 1em;">
                
                <input type="tel" id="phone" inputmode="numeric" placeholder="رقم الهاتف (أرقام فقط) *" style="width:100%; padding:15px; margin-bottom:12px; border:1px solid #ddd; border-radius:10px; box-sizing:border-box; font-size: 1em;">
                ...
                <input type="text" id="address" placeholder="العنوان بالتفصيل (البلدية، الحي..) *" style="width:100%; padding:15px; margin-bottom:15px; border:1px solid #ddd; border-radius:10px; box-sizing:border-box; font-size: 1em;">

                <p style="font-weight: bold; font-size: 0.95em; margin: 15px 0 10px; color: #444;">وسيلة التوصيل (مصاريف الشحن):</p>
                ...
                <button onclick="sendOrder()" id="btn-submit" style="width:100%; padding:20px; background:#e63946; color:white; border:none; border-radius:10px; font-size:1.5em; font-weight:900; cursor:pointer; box-shadow: 0 4px 12px rgba(230,57,70,0.4);">تأكيد الطلب الآن</button>
            </div>
        </div>
    `;
}
            ...
            mainCard.innerHTML = `
                <div style="padding: 60px 20px; text-align: center; background: white; animation: fadeIn 0.5s;">
                    ...
                    <p style="font-size: 1.3em; color: #333; line-height: 1.6;">
                        ...
                        <br><br>
                        سيتصل بك فريقنا هاتفياً لتأكيد العنوان وموعد التسليم.
                    </p>
                </div>
            `;
        }
